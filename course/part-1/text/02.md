...
In this exercise you get to think a bit about bytes (Note: It's rude to not laugh at bad puns). Exercise instuctions can be found in the template as usual, in the file `bytes.cpp`.
