...
In this exercise you will implement several functions that handle strings. You'll find the exercise description in the exercise template, in the file `strings.cpp`.
...
In this exercise you get to think a bit about bytes (Note: It's rude to not laugh at bad puns). Exercise description can be found in the template as usual, in the file `bytes.cpp`.
