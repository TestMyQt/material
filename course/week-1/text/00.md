# Creating and debugging Qt projects (P0 | 0,5h)
...
![]({{ "/assets/images/week-1/topic00-QtConcurrentNamespace.png" | absolute_url }})
...
![]({{ "/assets/images/week-1/topic00-QtConcurrentNoSuchFile.png" | absolute_url }})
...
![]({{ "/assets/images/week-1/topic00-QtConcurrentNoSuchFileDropdown.png" | absolute_url }})

The QtConcurrent is visible in the dropdown list that appeared! Are we good to go here?

![]({{ "/assets/images/week-1/topic00-QtConcurrentQtConcurrent.png" | absolute_url }})

Well, it looks like we have our include all sorted now, however this doesn't look like what the documentation suggested?

![]({{ "/assets/images/week-1/topic00-QtConcurrentInProFile.png" | absolute_url }})
...
![]({{ "/assets/images/week-1/topic00-QtConcurrentWorks.png" | absolute_url }})
