...
## Exercise - 03_HocusFocus

In this exercise you'll be passing focus between items. File you need to edit is `FocusGrid.qml`, where you'll also find the exercise description.

## Exercise - 04_KeyHandling

In this exercise we move a box with arrow keys and change its color with the tab-key. File you need to edit is `MovableBox.qml`, and again you'll find the exercise description there.
