...
// Pikkuisen modaisin tota esimerkkiä, että se asynkroninen loadaus ja sen tilan nappaaminen tulisi esille. *J: async lisätty, Tilan nappaaminen?*
// eli esimerrkkiin vaikka visible on true kun signal handler sanoo että loaded on true
