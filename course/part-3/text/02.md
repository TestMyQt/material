// Muuttaisin tän: Properties and Property Bindings
// Noi Perustyypit ei ole se suola

# 3.02 - Items and Rectangle, Image, BorderImage, Text 
...
// ATTACHED and GROUPED proerpties. Esim. Keys ja anchors { top: jotain; bottom: jotain }
...
// Tässä voisi olla aliotsikko "Some bqsic QML tupes"
...
// Pikkuisen modaisin tota esimerkkiä, että se asynkroninen loadaus ja sen tilan nappaaminen tulisi esille. 
...
// Mikä on explicit ja implicit ero
// Olis hyvä myös mainita, että explicit koko on huono, kun aiheuttaa layout re-calculation
