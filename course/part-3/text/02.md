# 3.02 - Rectangle, Image, BorderImage, Text 

## Items and their properties

// This chapter seems incoherent as a whole. Discussion about Item and visual parents feels out of place here. Thinking about extending that to the last chapter and making this just about the use of Rectangle, Image, BorderImage, and Text. At least partly if not completely.
...
The concept of `QObject` inheritance was discussed in Part 2. In this part we will be taking a look at visual parents and children, and it is important to understand how the concept differs from `QObject` inheritance. An item's visual parent may not necessarily be the same as its object parent.
